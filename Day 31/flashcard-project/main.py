...
class MakeGui(tk.Tk):
    def __init__(self):
        ...
        self.language_id = self.canvas.create_text(380, 200, text="",
                                                   font=("Ariel", 40, 'italic'),
                                                   fill="black")
        self.word_id = self.canvas.create_text(380, 250, text="",
                                               font=("Ariel", 60, 'bold'),
                                               fill="black")
        ...
        self.right_button = tk.Button(image=self.right_img, highlightthickness=0)
    ...
    def ask_question(self):
        ...
        self.canvas.itemconfig(self.language_id, text="French\n\n", fill="black")
        self.canvas.itemconfig(self.word_id, text=f"{question}", fill="black")
    ...
    def change_img(self, answer, idx):
        ...
        self.canvas.itemconfig(self.language_id, text="English\n\n", fill="white")
        self.canvas.itemconfig(self.word_id, text=f"{answer}", fill="white")
